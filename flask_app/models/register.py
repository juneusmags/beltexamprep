...
class User:
    ...
    def register_user(cls, data):
        ...
        return connectToMySQL('beltprep').query_db(query,data)


    @classmethod
    def get_by_email(cls,data):
        query = "SELECT * FROM users WHERE email = %(email)s;"
        result = connectToMySQL("beltprep").query_db(query,data)
    ...
    def one_user(cls, data):
        ...
        only_user = connectToMySQL("beltprep").query_db(query,data)
